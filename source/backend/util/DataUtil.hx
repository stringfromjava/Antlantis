...
final class DataUtil
{
	...
	/**
	 * Checks if string `s` only contains characters from string `validChars`.
	 * This is for when you don't want to use a regex.
	 *  
	 * @param s          The string to be checked.
	 * @param validChars A string of valid characters that can be in string `s`.
	 * @return If the name has no invalid characters. 
	 */
	public static function containsValidCharacters(s:String, validChars:String):Bool
	{
		for (i in 0...s.length)
		{
